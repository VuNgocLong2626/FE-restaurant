...
export default function SidebarNav() {
  return (
    <ul className="list-unstyled">
      ...
      <SidebarNavItem icon={faCode} href="/Admin/information">
        Thông tin (SSR)
        <small className="ms-auto">
      ...
      <SidebarNavTitle>Quản lý loại</SidebarNavTitle>
      <SidebarNavItem icon={faDroplet} href="/Admin/category-admin">
        Tất cả loại món ăn
      </SidebarNavItem>
      <SidebarNavItem icon={faPencil} href="/Admin/category-create-admin">
        Tạo loại món ăn
      </SidebarNavItem>
      ...
      <SidebarNavTitle>Quản trang</SidebarNavTitle>
